...
description: Document a completed work session to AI-Memory so future agents can learn what was done, why, and what's next. Trigger AGGRESSIVELY on any wrap-up signal - user does NOT need to say "session" or "vault" for this to activate. Intent triggers (English + Vietnamese, all should activate this skill) - Wrap-up / completion signals: "done for today", "that's a wrap", "closing the laptop", "wrap up", "calling it", "let's stop here", "I'm out", "xong rồi", "chốt thôi", "đóng máy", "xong việc", "kết thúc nhé", "tạm dừng ở đây", "đi nghỉ", "out đây", "off work"; Progress preservation: "save what we did", "log this work", "persist our progress", "record today's work", "lưu lại những gì đã làm", "ghi lại tiến độ", "log lại công việc", "lưu phiên", "chốt phiên", "lưu lại session"; Session summary request: "summarize what we did", "recap today", "give me a summary of this work", "tóm tắt hôm nay làm gì", "tổng kết phiên", "tóm lại đã làm gì"; Handoff intent: "next time I should know", "for tomorrow's session", "follow-ups for next time", "lần sau cần nhớ gì", "follow-up cho mai", "bàn giao". When uncertain whether the user wants the session logged, PREFER triggering - the cost of an unnecessary log is tiny compared to the cost of losing context. Creates structured report: task, outcome, files touched, findings, follow-ups. Threshold floor: skip if session <5 min AND read-only with no decision made.
