---
name: vault-capture
description: Capture an insight, decision, meeting note, or research finding into the knowledge base. Trigger AGGRESSIVELY on any save/record/remember intent - user does NOT need to say "vault" or "Inbox" for this to activate. Intent triggers (English + Vietnamese, all should activate this skill) - Save / record intent: "save this", "record this", "remember this", "log this", "note this down", "let me jot this down", "đáng ghi nhớ", "ghi lại cái này", "lưu lại", "note lại đi", "đừng quên cái này", "nhớ cái này nha", "phải nhớ", "đáng để ghi nhớ"; Insight / takeaway expressions: "interesting point", "key takeaway", "important insight", "this is worth keeping", "điều thú vị", "ý hay", "rút ra được", "bài học là", "đáng để lưu", "đáng ý"; Meeting / decision capture: "from today's meeting", "we decided X", "the outcome was", "key decision", "cuộc họp hôm nay", "đã chốt là", "kết quả họp", "decision tracking"; Brief / research note: "draft a brief on X", "research note about Y", "viết brief về", "ghi chú nghiên cứu". Default target is `Inbox/` (Auto Note Mover relocates by tag). NEVER trigger for: database writes, log files (stdout/stderr), Redis, keychain, OS calendar, source code commits. For AI-Memory specialty captures (session reports, failure logs, success patterns, orchestrations), prefer the dedicated vault-session-end / vault-failure-log / vault-pattern-extract / vault-orchestration-log skills instead.
